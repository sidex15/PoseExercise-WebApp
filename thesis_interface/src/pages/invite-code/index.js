          ...
          <div className="h-full laptop:w-2/5 w-full relative">
              <div className="absolute h-full laptop:w-full w-full flex flex-col justify-center">
                  ...
                  <div className="flex flex-col tablet:pt-32 pt-16">
                      ...
                      <input type="text" name="fn" className="laptopL:w-fit laptop:w-56 tablet:w-fit w-90% self-center border-solid border-2 border-cyan-blue bg-white rounded-md mt-5 p-2 font-bold text-xl text-center"/>
                      <button type="submit" onClick={registerUser} className="self-center bg-cyan-blue font-bold rounded-3xl text-white p-4 w-32 tablet:mt-28 mt-20">Proceed</button>   
                  </div>
              </div>
