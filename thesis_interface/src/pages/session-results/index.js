    ...
    return ( 
        <Layout>
            <div className="bg-grey h-full w-full flex flex-col justify-center items-center">
                ...
                <div className="bg-white w-4/5 h-3/4 flex flex-col justify-around items-center py-7 shadow-lg shadow-rgba(3,4,94,0.3)">
                    <div className="bg-grey rounded-2xl flex justify-around w-3/5 h-24">
                        ...
                        <div className="flex items-center gap-3 p-4">
                            <TbClockFilled size="60px" className="text-timberwolf" />
                    ...
                    <div className="w-3/5 flex justify-around">
                        <div className="bg-grey rounded-2xl flex flex-col relative p-3 w-52">
